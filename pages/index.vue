<template>
  ...
  <div class="mt-5 max-w-6xl mx-auto">
    <div class="grid grid-cols-2 sm:grid-cols-1 lg:grid-cols-4 gap-4">
      <div class="bg-white p-5 shadow-md rounded-2xl flex">
        <div class="my-auto text-stone-500 mr-3">
      ...
      <div class="bg-white p-5 shadow-md rounded-2xl flex">
        ...
        <div class="flex-col">
          ...
          <div class="font-semibold text-sm text-stone-400">Total Order</div>
        </div>
      </div>
      <div class="bg-white p-5 shadow-md rounded-2xl flex">
        <div class="my-auto text-stone-500 mr-3">
          ...
          <div class="flex-col">
            ...
            <div class="font-semibold text-sm text-stone-400">Pizza Terjual</div>
          </div>
      </div>
    </div>
